...
**🔹 Features:**
- Supports one read or write per clock using a valid + WR handshake.
- Synchronous read: output updates on the clock edge when WR=0.
- Synchronous write: stores data_in into the addressed location when WR=1.
